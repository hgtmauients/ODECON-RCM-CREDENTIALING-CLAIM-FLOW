...
API_CERT_HTTP_TIMEOUT_SECONDS = float(os.getenv("API_CERT_HTTP_TIMEOUT_SECONDS", "30"))
API_CERT_HTTP_MAX_RETRIES = max(0, int(os.getenv("API_CERT_HTTP_MAX_RETRIES", "2")))
API_CERT_HTTP_RETRY_BACKOFF_SECONDS = float(os.getenv("API_CERT_HTTP_RETRY_BACKOFF_SECONDS", "0.2"))
    ...
    async def get_coverage(self) -> Dict[str, List[str]]:
        ...
        try:
            resp = await request_with_retry(
                method="GET",
                url=f"{self.base_url}/v1/states",
                headers={"X-API-Key": self.api_key},
                timeout_seconds=API_CERT_HTTP_TIMEOUT_SECONDS,
                max_retries=API_CERT_HTTP_MAX_RETRIES,
                retry_backoff_seconds=API_CERT_HTTP_RETRY_BACKOFF_SECONDS,
