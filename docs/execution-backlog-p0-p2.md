...
- Status: expanded in-progress (security signal records now carry structured `security_event` + `security_fields` in log payloads with unit coverage for formatter output)
